...
public class ShatterTool : MonoBehaviour
{
    ...
    GameObject[] newCreateGameObjects;
    /// <summary>
    ...
    public void Shatter(Vector3 point)
    {
        if (!IsLastGeneration)
        {
            ...
            Split(planes, out newCreateGameObjects);
        }
    }
    /// <summary>
    ...
    /// </param>
    public void Split(Plane[] planes, out GameObject[] newCreateGameObjects)
    {
        if (planes != null && planes.Length > 0 && hull != null && !hull.IsEmpty)
        {
            ...
            if (uvMapper != null)
            {
                ...
                newCreateGameObjects = newGameObjects;
